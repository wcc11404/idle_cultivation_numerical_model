...
SERVER_AREAS_PATH = SERVER_ROOT / "app/modules/lianli/areas.json"
SERVER_ENEMIES_PATH = SERVER_ROOT / "app/modules/lianli/enemies.json"
SERVER_ITEMS_PATH = SERVER_ROOT / "app/modules/inventory/items.json"
